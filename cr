...
do -- Example UI
	local Window = library:AddWindow("Furk - Combat Rift", {
	...
	do -- Elements
		...
		Tab:AddButton("GUI 1", function()
    	loadstring(game:HttpGet("https://raw.githubusercontent.com/Introvert1337/SpooderScripts/main/CombatRift/MainScript.lua"))()
		end)
    Tab:AddButton("GUI 2", function()
loadstring(game:HttpGet("https://pastebin.com/raw/fciGpeVJ", true))()
		end)
