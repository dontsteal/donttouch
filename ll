...
do -- Example UI
	...
	do -- Elements
		...
		Tab:AddButton("#1 GUI", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/Evzc/scripts/main/Lifting_Titans.lua", true))()
		end)
		Tab:AddButton("SkyHub GUI", function()
			-- SETTING THEME --
