...
do -- Example UI
	local Window = library:AddWindow("Furk - Hero Simulator", {
	...
	do -- Elements
		...
		Tab:AddButton("Awesome GUI", function()
    loadstring(game:HttpGet(("https://dosage.wtf/files/herosim.lua"), true))()
		end)
    Tab:AddButton("OP GUI", function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/LordGrape/Prpl/main/Hero%20Simulator", true))() 
		end)
