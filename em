...
do -- Example UI
	local Window = library:AddWindow("Furk - Epic Minigames", {
	...
	do -- Elements
		...
		Tab:AddLabel("After executing the Bypass GUI below")
    Tab:AddLabel("Use the local commands from the Furk Ultra Local scripts tab!")
    Tab:AddLabel("It's the human icon on the left of the Furk Ultra UI!")

    Tab:AddButton("Bypass GUI", function()
 loadstring(game:HttpGet("https://pastebin.com/raw/pY8JXt6g"))();
		end)
